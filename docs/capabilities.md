...
- Material feature support such as clearcoat factor, clearcoat-roughness, and
  clearcoat-normal texture sampling in CPU/reference and GPU shader paths
  versus backend-gated release proof.
