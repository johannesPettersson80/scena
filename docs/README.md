...
- [docs.rs API reference](https://docs.rs/scena/1.0.0/scena/): generated Rust API docs.
...
- [v1.0.0 release notes](release-notes/v1.0.0.md): published release evidence and compatibility notes.
