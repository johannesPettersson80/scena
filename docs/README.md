...
- [docs.rs API reference](https://docs.rs/scena/1.0.1/scena/): generated Rust API docs.
...
- [v1.0.1 release notes](release-notes/v1.0.1.md): published release evidence and compatibility notes.
