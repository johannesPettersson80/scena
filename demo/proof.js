import init, {
  ...
  tick,
} from "./proof/pkg/scena.js?v=1.10.6-proof-6ad8878cd48c";
...
function updateCodePanel() {
  if (activeAsset.code === "v14-presets") {
    ...
    codeSubtitle.textContent = "scena 1.10.6 — pick a name, not a number";
...
async function start() {
  ...
  await init({
    module_or_path: new URL(
      "./proof/pkg/scena_bg.wasm?v=1.10.6-proof-6ad8878cd48c",
      import.meta.url,
    ),
  });
  wireDragDrop();
