...
/// Polyhaven `studio_small_08_1k.hdr` — CC0, real-world studio HDR with
/// smooth radiance falloff. Bundled at
/// `tests/assets/environment/polyhaven/studio_small_08_1k.hdr` and pinned
...
const STUDIO_HDR_PATH: &str = "tests/assets/environment/polyhaven/studio_small_08_1k.hdr";
const STUDIO_HDR_SHA256: &str = "f6a989f89432eb4eee3191364a9c1ceed195c4ec3544173a3c04fd96cb91d0ba";
