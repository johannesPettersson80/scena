...
fn scena_schema_cli_lists_and_gets_stable_contracts() {
    ...
    assert_schema(&catalog, "scena.focus_report.v1");
    assert_schema(&catalog, "scena.exposure_report.v1");
    assert_schema(&catalog, "scena.subject_observation.v1");
    ...
    assert_schema(&catalog, "scena.photo_render_result.v1");
    assert_schema(&catalog, "scena.photo_plan.v1");
    assert_schema(&catalog, "scena.photo_candidate_plan.v1");
    assert_schema(&catalog, "scena.photo_shaded_candidate_selection.v1");
    assert_schema(&catalog, "scena.photo_report.v1");
    ...
    assert_schema(&catalog, "scena.asset_conversion.v1");
    ...
    assert_schema(&catalog, "scena.agent_template_catalog.v1");
    assert_schema(&catalog, "scena.browser_proof_run.v1");
    assert_schema(&catalog, "scena.q01.required_webgpu_pixel_parity.v1");
