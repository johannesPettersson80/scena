...
pub fn schema_entry_report_v1(schema: &str) -> Option<SchemaEntryReportV1> {
    ...
    let example = schema_fixture_json(schema)
...
fn schema_fixture_json(schema: &str) -> Option<&'static str> {
    schema_fixture_map()
        .iter()
...
fn schema_fixture_map() -> &'static [(&'static str, &'static str)] {
    &[
        ...
        (
            ...
            include_str!("../tests/assets/stable-contracts/scene_host_animation_inventory.v1.json"),
        ),
        (
