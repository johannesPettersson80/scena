...
impl Renderer {
    ...
    pub(super) fn from_raster_target(
        ...
        Ok(Self {
            ...
            cpu_effect_linear_scratch: Vec::new(),
            cpu_effect_linear_scratch_2: Vec::new(),
            cpu_meter_linear_frame: Vec::new(),
            ...
            environment_rotation_y_radians: 0.0,
            environment_lighting_cache: Default::default(),
            background_color: Color::BLACK,
            auto_exposure: None,
            auto_exposure_subject_metering: None,
            explicit_exposure_ev: false,
