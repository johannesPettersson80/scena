...
pub use types::{
    ...
    SceneRecipeCameraV1, SceneRecipeCaptureV1, SceneRecipeColorV1, SceneRecipeDiagnosticV1,
    SceneRecipeExpectedExtentV1, SceneRecipeExplodedViewModeV1, SceneRecipeExplodedViewV1,
    SceneRecipeGeometryV1, SceneRecipeImportV1, SceneRecipeLookAtTargetV1, SceneRecipeMaterialV1,
