...
use crate::assets::{
    AssetMaterialFallbackV1, AssetMaterialSource, AssetMaterialSourceKind, AssetProvenance,
    TextureSourceFormat,
};
use crate::geometry::{Aabb, GeometryTopology};
use crate::material::{AlphaMode, Color, MaterialKind, TextureColorSpace};

use super::super::{CameraKey, InstanceId, NodeKey, Transform, Vec3};
use super::{SceneInspectionReport, SceneMaterialInspection, SceneTextureInspection};
                ...
                .filter_map(|node| {
                    ...
                    Some(SceneNodeInspectionV1 {
                        ...
                        material: source
                            .material_preview
                            .as_ref()
                            .map(SceneMaterialInspectionV1::from),
                    })
                })
                .collect(),
            draw_list: self
...
impl From<&SceneMaterialInspection> for SceneMaterialInspectionV1 {
    fn from(material: &SceneMaterialInspection) -> Self {
        ...
        Self {
            ...
            source: material
                .source()
                .map(SceneMaterialSourceInspectionV1::from)
                .unwrap_or_else(SceneMaterialSourceInspectionV1::unknown),
...
impl From<&AssetMaterialSource> for SceneMaterialSourceInspectionV1 {
    fn from(source: &AssetMaterialSource) -> Self {
        Self {
...
impl SceneMaterialSourceInspectionV1 {
    fn unknown() -> Self {
        Self {
