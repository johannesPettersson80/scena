...
pub use scene::recipe::{
    ...
    SCENE_RECIPE_VALIDATION_SCHEMA_V1, SceneRecipeAlphaModeV1, SceneRecipeBuildImportV1,
    ...
    SceneRecipeCaptureV1, SceneRecipeColorV1, SceneRecipeDiagnosticV1, SceneRecipeExpectedExtentV1,
    ...
    SceneRecipeMeasurementV1, SceneRecipeMeshV1, SceneRecipeNodeV1, SceneRecipePrimitiveV1,
