...
mod tests {
    ...
    #[test]
    fn doctor_rejects_m6_browser_renderer_probe_missing_cargo_dep_regression() {
...
"#,
    ...
    #[test]
    fn doctor_rejects_render_lifecycle_doc_missing_substring_regression() {
        let root = repo_root().expect("test runs inside the scena workspace");
        ...
        assert!(
            findings.iter().any(|finding| finding.rule == "DOCS-LIFECYCLE"),
    ...
    #[test]
    fn doctor_rejects_asset_gltf_doc_missing_substring_regression() {
        let root = repo_root().expect("test runs inside the scena workspace");
    ...
    #[test]
    fn doctor_rejects_visual_quality_doc_missing_substring_regression() {
        let root = repo_root().expect("test runs inside the scena workspace");
    ...
    #[test]
    fn doctor_rejects_doctor_contract_doc_missing_substring_regression() {
        let root = repo_root().expect("test runs inside the scena workspace");
    ...
    #[test]
    fn doctor_rejects_release_gates_doc_missing_substring_regression() {
        let root = repo_root().expect("test runs inside the scena workspace");
        ...
        assert!(
            findings.iter().any(|finding| finding.rule == "DOCS-RELEASE-GATES"),
    ...
    #[test]
    fn doctor_rejects_public_api_doc_missing_substring_regression() {
        let root = repo_root().expect("test runs inside the scena workspace");
        ...
        assert!(
            findings.iter().any(|finding| finding.rule == "DOCS-PUBLIC-API"),
    ...
    #[test]
    fn doctor_rejects_required_docs_missing_file_regression() {
        ...
        assert!(
            findings.iter().any(|finding| finding.rule == "DOCS-REQUIRED"),
    ...
    #[test]
    fn doctor_rejects_m5_release_cargo_missing_metadata_regression() {
        ...
        assert!(
            findings.iter().any(|finding| finding.rule == "ARCH-M5-RELEASE"),
    ...
    #[test]
    fn doctor_rejects_visual_browser_m1_missing_artifact_regression() {
        ...
        assert!(
            findings.iter().any(|finding| finding.rule == "VISUAL-BROWSER-M1"),
