...
pub(crate) fn write_scena_viewer_element_easy_scene_fixture(fixture_root: &Path) {
    ...
    fs::write(
        ...
        "<scena-viewer defineScenaViewer viewer-element shadow DOM canvas progressbar scena-viewer-progress drag-and-drop scena-viewer-file-drop scena-viewer-drop-error render-after-drop scena-viewer-drop-render viewer-level-auto-framing material variant picker scena-viewer-variant-change mobile accessibility keyboard scena-viewer-key-control scena-viewer-gesture-control pinch-zoom inspector/dev overlay setInspectorSnapshot scena-viewer-inspector-rendered annotation overlay data-position scena-viewer-annotations-request scena-viewer-annotations-rendered SCENA_BROWSER_VIEWER_ELEMENT_ONLY=1 scena-viewer-element-browser-proof.png",
    )
