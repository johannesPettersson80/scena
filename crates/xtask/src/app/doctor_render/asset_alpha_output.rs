...
pub(crate) fn check_asset_api_contracts(root: &Path, findings: &mut Vec<Finding>) {
    ...
    require_contains(
        ...
        &[
            ...
            "let stroke_width_px = Some(positive_or",
...
pub(crate) fn check_fxaa_output_contracts(root: &Path, findings: &mut Vec<Finding>) {
    ...
    require_contains(
        ...
        &[
            ...
            "anti_aliasing_can_be_disabled_for_on_off_visual_proof",
            "weighted_blended_transparency_is_order_independent_for_overlaps",
            "OrderIndependentTransparencyConfig::weighted_blended()",
            "stats().order_independent_transparency_passes",
            "AntiAliasing::None",
            "AntiAliasing::Fxaa",
    ...
    require_contains(
        ...
        &[
            ...
            "render_anti_aliasing_on_off",
            "validate_anti_aliasing_on_off",
            "render_oit_overlap_order_invariance",
            "validate_oit_overlap_order_invariance",
            "ssao-contact-on-off",
