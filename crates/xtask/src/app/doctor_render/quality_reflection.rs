...
pub(crate) fn check_render_quality_reflection_contracts(root: &Path, findings: &mut Vec<Finding>) {
    ...
    require_contains(
        ...
        &[
            ...
            "reflection_quality_known_bad_flat_chrome_fails_exact_reason",
            "reflection_firefly_outliers",
            "reflection_chrome_read_missing",
            "max_firefly_fraction",
            "flat_dark_chrome_fixture",
    ...
    require_contains(
        ...
        &[
            ...
            "scena_recipe_render_verify_fails_missing_chrome_read_on_cpu_and_gpu",
            ...
            "scena_recipe_render_ergonomic_product_scene_reaches_rust_api_quality_on_cpu_and_gpu",
