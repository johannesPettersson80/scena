...
pub(crate) const CURRENT_RELEASE_VERSION: &str = "1.10.2";
pub(crate) const CURRENT_RELEASE_NOTES: &str = "docs/release-notes/v1.10.2.md";
pub(crate) const CURRENT_REVIEW_REPORT: &str = "docs/reviews/release-v1.10.2.md";
pub(crate) const CURRENT_REMEDIATION_CHECKLIST: &str = "docs/checklists/release-v1.10.2.md";
...
pub(crate) fn finding_reference(rule: &str) -> &'static str {
        ...
        || rule.contains("ASSETS")
    {
        ...
        || rule == "STABLE-CONTRACT-EVIDENCE"
        || rule == "ARCH-RENDER-QUALITY"
    {
