...
pub(crate) const CURRENT_RELEASE_VERSION: &str = "1.10.6";
pub(crate) const CURRENT_RELEASE_NOTES: &str = "docs/release-notes/v1.10.6.md";
pub(crate) const CURRENT_REVIEW_REPORT: &str = "docs/reviews/release-v1.10.6.md";
pub(crate) const CURRENT_REMEDIATION_CHECKLIST: &str = "docs/checklists/release-v1.10.6.md";
