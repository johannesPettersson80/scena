...
pub(crate) use crate::app::doctor_core::{
    ...
    REQUIRED_SOURCE_MODULES, SOURCE_SCOPE_TERMS, STALE_DOC_TERMS, check_cli_output_contracts,
    check_cpu_ibl_gap_documented, check_feature_gated_contract_tests_documented,
    check_feature_ownership_contracts, check_m8_real_asset_dual_lane,
...
pub(crate) use crate::app::doctor_docs::{
    check_c11_onboarding_contracts, check_demo_build_heartbeat_contract, check_for_stale_doc_terms,
...
pub(crate) use crate::app::doctor_scene_platform::{
    ...
    check_c10_overlay_ownership_contracts, check_c12_deformed_picking_contracts,
    check_c13_strict_gpu_construction_contracts, check_calibration_oracles_pair_parity_sweeps,
    ...
    check_equirectangular_hdr_environment_contracts, check_fr05_capture_sequence_contracts,
    check_fr06_semantic_aov_contracts, check_fr07_recipe_diff_contracts,
    check_fr08_recipe_spatial_state_contracts, check_m2_leak_stats_contracts,
    ...
    check_webgl2_depth_contracts, contains_scope_term,
};
pub(crate) use crate::app::doctor_visual_release::{
    ...
    check_pf10_hot_path_contracts, check_q01_waterbottle_cpu_proof,
    check_q02_round_e_material_proof, check_q04_cpu_webgl2_parity_contracts,
    check_q05_effect_footprint_contracts, check_q06_required_gpu_lane_contracts,
    check_release_publish_dry_run_helper, check_release_readiness_ci_fail_closed,
    check_visual_fixture_metadata, check_workflow_action_pins, fixture_block,
    jobs_with_continue_on_error_release_readiness, require_contains_in_xtask_app_tree,
};
...
pub(crate) use crate::app::release::{
    ...
    REQUIRED_VISUAL_PROOF_ARTIFACT_SUFFIXES, ReleaseFindingBlock,
    browser_probe_release_proof_passes, check_release_artifact_bundle, check_release_readiness,
    check_release_readiness_adr, check_release_readiness_artifact_env,
    check_release_readiness_checklists, check_release_review_artifacts, copy_optional_json_field,
    finalize_waterbottle_cpu_result, finalize_waterbottle_gpu_result, iterate_finding_blocks,
    parse_release_review_frontmatter, release_artifact_commit_label, release_lane_artifact,
    release_lane_command_records, release_lane_command_records_pass, release_lane_content_ok,
    release_lane_evidence, release_lane_expected_commands, release_lane_measured_command_records,
    release_lane_required_artifacts, require_json_status_passed,
    required_browser_gpu_parity_passes, run_claim_audit, run_release_lane_artifact,
    run_release_readiness, run_stage_release_artifacts, scrape_toml_bool_value,
    scrape_toml_string_value, stage_release_artifacts, stage_release_artifacts_for_commit,
    utc_rfc3339_from_unix, validate_browser_backend_result, validate_findings_register_schema,
...
pub(crate) use crate::app::util::{
    ...
    public_fields_in_struct, rust_cfg_test_module_names, significant_line_count, source_files,
    strip_rust_visibility,
};
