...
pub(crate) use crate::app::doctor_render::{
    ...
    check_prepare_asset_contracts, check_render_alpha_contracts, check_render_movement_contracts,
    check_render_quality_contracts, check_render_quality_reflection_contracts,
...
pub(crate) use crate::app::doctor_scene_platform::{
    ...
    check_fr07_recipe_diff_contracts, check_fr08_recipe_spatial_state_contracts,
    check_full_review_cpu_depth_clipping_contracts,
